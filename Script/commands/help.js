...
module.exports.run = function({ api, event, args, getText }) {
        ...
        return axios.get('https://loidsenpaihelpapi.miraiandgoat.repl.co').then(res => {
            ...
            api.getUserInfo(parseInt(admID), (err, data) => {
                ...
                let callback = function () {
                    api.sendMessage({
                        body: `✿🄲🄾🄼🄼🄰🄽🄳 🄻🄸🅂🅃✿\n\n` + msg + `✿══════════════✿\n│𝗨𝘀𝗲 ${prefix}help [Name?]\n│𝗨𝘀𝗲 ${prefix}help [Page?]\n│𝗡𝗔𝗠𝗘 𝗢𝗪𝗡𝗘𝗥 : │ Shakil\n│𝗙𝗔𝗖𝗘𝗕𝗢𝗢𝗞 : │ https://www.facebook.com/HD.TOM.TERA.NEXT.CRUSH\n│𝗧𝗢𝗧𝗔𝗟 :  ${commands.size}\n————————————`,
                        mentions: [{
                            tag: firstname,
                            id: admID,
                            fromIndex: 0,
    ...
    if (!command) {
        ...
        var callback = () => api.sendMessage({
            body: siu + "\n\n" + msg + text,
            attachment: fs.createReadStream(__dirname + "/cache/loidbutter.jpg")
        }, event.threadID, () => fs.unlinkSync(__dirname + "/cache/loidbutter.jpg"), event.messageID);
